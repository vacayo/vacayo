...
from vacayo.views.api import UserView, AddressView, PropertyView, PropertiesView, RegistrationView, HostView, LeadView, PropertySearchView
...
urlpatterns = [
    ...
    url(r'^api/properties/search/$', PropertySearchView.as_view()),
